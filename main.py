...
parser.add_argument("--count", type=int, help="Max number of combinations to generate. Default is 1 million", default=1000)
...
if args.i:
    ...
    tm.find_in_range(args.i, args.lower, args.upper, args.count)